<p align="center">
  <picture>
    ...
    <img src="./icon-light.png" alt="Fine-tuning" width="144" />
  </picture>
</p>
...
**App:** [Install](ryu://apps/@ryu/finetune) (opens the Ryu desktop app and asks you to confirm)

**CLI:**

```bash
ryu apps add @ryu/finetune
```

**Crate:**

```bash
cargo install ryu-finetune
```
